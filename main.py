...
# Dynamic database for client apps, chat logs, and developer questions
...
# ==========================================================
    ...
    with col_chat_view:
        ...
        # Action 1: Send a normal text update
        ...
        # Action 2: Send a dot-selection question
        st.write("---")
...
# ==========================================================
    ...
    with col_interaction:
        ...
        # DYNAMIC DOT SELECTION BOX (If developer sent a question)
        ...
        if q_data:
            ...
            if st.button("Submit Chosen Dot"):
                ...
                st.session_state.apps[active_app]["active_question"] = None  # Clears question once answered
                st.rerun()
        else:
